    ...
    <table class="k-structure-table">
      <thead>
        <tr>
          ...
          <th data-width="1/3" class="k-structure-table-column">Path</th>
          <th data-width="1/3" class="k-structure-table-column">Referrer</th>
          <th data-width="1/6" class="k-structure-table-column">Hits (Redirected)</th>
          <th />
        </tr>
      </thead>
      <tbody>
